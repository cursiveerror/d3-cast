...
Оскільки проєкт є повністю статичним, його розгортання займає кілька секунд:

1. Склонуйте репозиторій:
   ```bash
   git clone [https://github.com/cursiveerror/d3-cast.git](https://github.com/cursiveerror/d3-cast.git)
